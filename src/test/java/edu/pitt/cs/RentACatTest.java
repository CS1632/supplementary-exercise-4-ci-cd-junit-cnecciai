...
public class RentACatTest {
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse("Cat ID: 2 - attempt to rent rented cat returning true", c2.getRented());

		Mockito.verify(c1, Mockito.times(0)).rentCat();
		//Should this remain as a singular invocation since wehave to call rentcat as part of the preconditions?
